function out = wsa_band_spectral_parameters(f, S)
%wsa_band_spectral_parameters - Calcula los parámetros espectrales para la
...
function out = empty_spectral_output()
out = struct( ...
    'm0', NaN, ...
    'm1', NaN, ...
    'm2', NaN, ...
